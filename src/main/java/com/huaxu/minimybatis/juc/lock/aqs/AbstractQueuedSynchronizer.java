package com.huaxu.minimybatis.juc.lock.aqs;

/**
 * @description: AbstractQueuedSynchronizer.java
 * <p></p>
 * @author: DongxuHua
 * @create: at 2021-09-10 2:20 下午
 * @version: 1.0.0
...
public class AbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements Serializable {
    ...
    final int fullyRelease(Node node) {
        //完全释放锁是否成功，当failed为false的时候，说明当前线程是未持有锁调用 await方法的线程..（错误写法..）
