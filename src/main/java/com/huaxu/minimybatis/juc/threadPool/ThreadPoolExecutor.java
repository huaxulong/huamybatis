...
public class ThreadPoolExecutor extends AbstractExecutorService {
    ...
    private volatile TempRejectedExecutionHandler handler;
    ...
    private static final TempRejectedExecutionHandler defaultHandler =
            new AbortPolicy();
    ...
    public ThreadPoolExecutor(int corePoolSize,
                              ...
                              TimeUnit unit,
                              BlockingQueue<Runnable> workQueue,
                              TempRejectedExecutionHandler handler) {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
    ...
    public ThreadPoolExecutor(int corePoolSize,//核心线程数限制
                              ...
                              TempRejectedExecutionHandler handler/*拒绝策略*/) {
        //判断参数是否越界
        if (corePoolSize < 0 ||
                maximumPoolSize <= 0 ||
     ...
     */
    public void setRejectedExecutionHandler(TempRejectedExecutionHandler handler) {
        if (handler == null)
            throw new NullPointerException();
        this.handler = handler;
    }
     ...
     * @see #setRejectedExecutionHandler(TempRejectedExecutionHandler)
     */
    public TempRejectedExecutionHandler getRejectedExecutionHandler() {
        return handler;
    }
     ...
     * is discarded.
     */
    public static class CallerRunsPolicy implements TempRejectedExecutionHandler {
        /**
     ...
     */
    public static class AbortPolicy implements TempRejectedExecutionHandler {
        /**
     ...
     * rejected task.
     */
    public static class DiscardPolicy implements TempRejectedExecutionHandler {
        /**
     ...
     */
    public static class DiscardOldestPolicy implements TempRejectedExecutionHandler {
        /**
